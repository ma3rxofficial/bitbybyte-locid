...
public final class g implements ag {
  private static final String[] a = v.a("/audio/vavr/\000/certs/\000/certs/root/\000/certs/root/x509/\000/certs/root/x509/kjava/\000/certs/root/x509/ssl/\000/email/\000/kjava/\000/licenses/\000/mib/\000/mib/cache/\000/mib/cookies/\000/mib/gen/\000/mib/offline/\000/mib/pcf/\000/mixedmedia/\000/mms/\000/mms/mmstemplate/\000/partial/\000/ringtone/\000/settings/\000/skins/\000/system/\000/wvim/\000", 0, false);
  ...
  private void a() {
    b();
    try {
      this.a = (String)Connector.open(v.a("file:///", this.a));
      return;
    } catch (Throwable throwable) {
      this.a = null;
      return;
  ...
  private boolean d(String paramString) {
    try {
      ...
      String[] arrayOfString = (fileConnection = (FileConnection)Connector.open(v.a("file:///", paramString))).list();
  ...
  public final String[] a() {
    ...
    a(1);
    if (this.a != null) {
      arrayOfString = a(this.a.list());
      b();
      Vector vector = new Vector(arrayOfString.length);
      byte b;
      ...
      for (b = 0; b < a.length; b++) {
        ...
        if ((i = a[b].lastIndexOf('/', a[b].length() - 2)) != -1) {
          ...
          if (this.a.equals(v.a("a/mobile", str))) {
            boolean bool = false;
            for (byte b1 = 0; b1 < vector.size(); b1++) {
              if (a[b].equals(vector.elementAt(b1))) {
                bool = true;
                break;
              } 
            } 
  ...
  private static String[] a(String[] paramArrayOfString) {
    if (paramArrayOfString == null || paramArrayOfString.length <= 0) {
      ...
      for (byte b = 0; b < paramArrayOfString.length; b++) {
        ...
        int j = -1;
        int i;
        if ((i = str.lastIndexOf('/')) == str.length() - 1) {
          if (i != -1)
  ...
  public final boolean b(String paramString) {
    ...
    a(2);
    if (this.a != null) {
      bool = this.a.rename(v.a("file:///", paramString));
      b();
    } 
    return bool;
  }
  ...
  public final void c(boolean paramBoolean) {
    a(2);
    try {
      this.a.setWriteable(paramBoolean);
    } catch (Throwable throwable) {}
    b();
  }
  ...
  public final int a(String paramString1, String paramString2, boolean paramBoolean) {
    ...
    try {
      ...
      if (!(fileConnection1 = (FileConnection)Connector.open(v.a("file:///", paramString1))).exists())
        throw new Exception(); 
      if (!ai.e(paramString1)) {
        ...
        try {
          ...
          String[] arrayOfString = a((fileConnection2 = (FileConnection)Connector.open(v.a("file:///", paramString1))).list());
  ...
  public final OutputStream a(long paramLong) {
    try {
      a(2);
      OutputStream outputStream = this.a.openOutputStream();
    } catch (Exception exception) {
      this = null;
    } 
  ...
  public final Vector a(String paramString, Vector paramVector) {
    try {
      FileConnection fileConnection;
      String[] arrayOfString = (fileConnection = (FileConnection)Connector.open(v.a("file:///", paramString), 1)).list();
      fileConnection.close();
      if (paramVector == null)
  ...
  public final boolean c(String paramString) {
    return ((this.b = (FileConnection)Connector.open(paramString, 3)) != null);
  }
...
/* Location:              D:\Desktop\kemulator\LocID_BitByByte.jar!\g.class
