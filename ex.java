public final class ex extends bj {
  public int i;
  ...
  private ex(long paramLong, int paramInt1, int paramInt2, String paramString, int paramInt3, byte[] paramArrayOfbyte1, byte[] paramArrayOfbyte2) {
    super(21, 3, paramInt1, paramLong, paramArrayOfbyte1, paramArrayOfbyte2);
    this.i = paramInt2;
    this.j = paramString;
    this.k = paramInt3;
  }
  ...
  public static dd a(byte[] paramArrayOfbyte, int paramInt1, int paramInt2) throws cr {
    ...
    return new ex(l, j, m, str, k, arrayOfByte1, arrayOfByte2);
  }
}


/* Location:              D:\Desktop\kemulator\LocID_BitByByte.jar!\ex.class
