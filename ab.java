...
public final class ab implements ag {
  ...
  public final String a() {
    return v.cJ ? ai.b(this.a) : this.a;
  }
  ...
  private boolean d(String paramString) {
    try {
      ...
      byte b = 0;
      while (b < arrayOfString.length && !ai.b) {
  ...
  public final String[] b() {
    String[] arrayOfString;
    if (v.G == '\002') {
      (arrayOfString = new String[4])[0] = "0:/";
      this[1] = "1:/";
      this[2] = "2:/";
      this[3] = "4:/";
    } else {
      ...
      if (v.G == null && !v.cI) {
        ...
        for (byte b2 = 0; b2 < vector.size(); b2++) {
          String str;
          if ((str = vector.elementAt(b2)) != null && str.length() < 6)
            this[b1++] = str; 
        } 
        if (b1 < vector.size()) {
          String[] arrayOfString1 = new String[b1];
          System.arraycopy(this, 0, arrayOfString1, 0, b1);
          arrayOfString = arrayOfString1;
        } 
      } else {
        vector.copyInto((Object[])this);
      } 
    } 
    return this;
  }
  ...
  public final void b(boolean paramBoolean) {
    a(2);
    try {
      this.a.setReadable(paramBoolean);
    } catch (Exception exception) {}
    b();
  }
      ...
      if (!ai.e(paramString1)) {
        ...
        try {
          ...
          for (b = 0; b < arrayOfString.length && (bool == true || bool == 2) && !ai.b; b++) {
            bool = b(v.a(paramString1, arrayOfString[b]), v.a(paramString2, arrayOfString[b]), paramBoolean);
  ...
  public final int a(String paramString1, String paramString2, boolean paramBoolean) {
    if (v.cJ) {
      paramString1 = ai.a(paramString1);
      paramString2 = ai.a(paramString2);
    } 
...
/* Location:              D:\Desktop\kemulator\LocID_BitByByte.jar!\ab.class
