...
public final class cu implements CommandListener, bx {
  private Command b;
  ...
  private void b(int paramInt) {
    ...
    if (this.x.a() > 0) {
      ...
      this.l.q();
      dw.a(this.x.a(paramInt), this.l, false);
      this.l.a_(bb.a((short)417) + " " + Integer.toString(paramInt + 1) + "/" + Integer.toString(this.x.a()));
      this.l.s();
    } else {
      this.l.q();
  ...
  public final void commandAction(Command paramCommand, Displayable paramDisplayable) {
    ...
    bu[] arrayOfBu = bi.h();
    if (paramCommand == this.d && dw.a(this.l)) {
    ...
    if (paramCommand == this.d && paramDisplayable == this.m) {
      this.k = null;
...
/* Location:              D:\Desktop\kemulator\LocID_BitByByte.jar!\cu.class
